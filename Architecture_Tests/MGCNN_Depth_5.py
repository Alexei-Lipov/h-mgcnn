...
class GCNN(torch.nn.Module):
    def __init__(self):
        ...
        self.conv1 = GCNConv(dataset[0].num_node_features, 1147)
        self.conv2 = GCNConv(1147, 862)
        self.conv3 = GCNConv(862, 577)
        self.conv4 = GCNConv(577,292)
        self.conv5 = GCNConv(292, dataset[0].num_classes)
